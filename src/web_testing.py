...
class WebTesting():
    ...
    def __init__(self, link: str):
        ...
        self.xpath_latest_feed = '/html/body/div[1]/div/div[2]/section[2]/div/div/div[1]/div/section[1]/div/div/header/div/div[1]/article/div[2]/div/div[2]/span'
        self.xpath_latest_name = '//*[@id="oC6bsXSsG"]/header/div/div[1]/article/div[2]/div/div[1]/a[1]'
        self.xpath_latest_title = '//*[@id="oC6bsXSsG"]/div[1]/h4' 
    ...
    @staticmethod
    def get_attribute_latest_news_feed_of_module(driver: webdriver, x_path: str) -> str:

        last_posted_date_element = WebTesting.get_web_element(driver=driver, x_path=x_path)
    ...
    @staticmethod
    def navigate_to_news_feed_of_module(driver: webdriver):
        """[summary]
    ...
    def append_date_of_las_posted_feed_to_csv(self):
        ...
        WebTesting.navigate_to_news_feed_of_module(driver=self.driver)

        last_feed_date_str = WebTesting.get_attribute_latest_news_feed_of_module(driver=self.driver, x_path=self.xpath_latest_feed)
        last_feed_name_str = WebTesting.get_attribute_latest_news_feed_of_module(driver=self.driver, x_path=self.xpath_latest_name)
        last_feed_title_str = WebTesting.get_attribute_latest_news_feed_of_module(driver=self.driver, x_path=self.xpath_latest_title)
